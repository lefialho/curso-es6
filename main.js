...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return initCollapse; });\n/* harmony import */ var _config_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./config.js */ \"./js/modules/config.js\");\n\r\n\r\nfunction initCollapse() {\r\n  const accordionList = document.querySelectorAll('[data-anime=\"accordion\"] dt');\r\n\r\n  function activeCollapse() {\r\n    console.log(this);\r\n    accordionList.forEach((item) => {\r\n      if (!this.classList.contains(_config_js__WEBPACK_IMPORTED_MODULE_0__[\"active\"])) {\r\n        item.classList.remove(_config_js__WEBPACK_IMPORTED_MODULE_0__[\"active\"]);\r\n        item.nextElementSibling.classList.remove(_config_js__WEBPACK_IMPORTED_MODULE_0__[\"active\"]);\r\n      }\r\n    });\r\n\r\n    this.classList.toggle(_config_js__WEBPACK_IMPORTED_MODULE_0__[\"active\"]);\r\n    this.nextElementSibling.classList.toggle(_config_js__WEBPACK_IMPORTED_MODULE_0__[\"active\"]);\r\n  }\r\n\r\n  if (accordionList.length) {\r\n    accordionList[0].classList.add(_config_js__WEBPACK_IMPORTED_MODULE_0__[\"active\"]);\r\n    accordionList[0].nextElementSibling.classList.add(_config_js__WEBPACK_IMPORTED_MODULE_0__[\"active\"]);\r\n\r\n    accordionList.forEach((item) => {\r\n      item.addEventListener('click', activeCollapse)\r\n    });\r\n  }\r\n}\n\n//# sourceURL=webpack:///./js/modules/accordion.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return initAnimaNumbers; });\n/* harmony import */ var _config_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./config.js */ \"./js/modules/config.js\");\n\r\n\r\nfunction initAnimaNumbers() {\r\n  function numbersAnimate() {\r\n    const numbers = document.querySelectorAll('[data-number]')\r\n\r\n    numbers.forEach((number) => {\r\n      const total = +number.innerText;\r\n      const increment = Math.round(total / 100);\r\n\r\n      let counter = 0\r\n      const timer = setInterval(() => {\r\n        counter += increment;\r\n        number.innerText = counter;\r\n\r\n        if (counter > total) {\r\n          number.innerText = total;\r\n          clearInterval(timer)\r\n        }\r\n      }, 25 * Math.random())\r\n    });\r\n  }\r\n\r\n  function handleMutation(mutation) {\r\n    if (mutation[0].target.classList.contains(_config_js__WEBPACK_IMPORTED_MODULE_0__[\"active\"])) {\r\n      observer.disconnect();\r\n      numbersAnimate();\r\n    }\r\n  }\r\n\r\n  const observerTarget = document.querySelector('.numbers');\r\n  const observer = new MutationObserver(handleMutation);\r\n\r\n  observer.observe(observerTarget, {\r\n    attributes: true\r\n  });\r\n}\n\n//# sourceURL=webpack:///./js/modules/anima-numbers.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return initDropDown; });\n/* harmony import */ var _config_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./config.js */ \"./js/modules/config.js\");\n/* harmony import */ var _outside_click_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./outside-click.js */ \"./js/modules/outside-click.js\");\n\n\n\n\nfunction initDropDown() {\n  const dropdownMenus = document.querySelectorAll('[data-dropdown]');\n\n  if (dropdownMenus) {\n    dropdownMenus.forEach(menu => {\n      _config_js__WEBPACK_IMPORTED_MODULE_0__[\"events\"].forEach(userEvent => {\n        menu.addEventListener(userEvent, handleClick)\n      });\n    });\n  }\n\n  function handleClick(event) {\n    event.preventDefault()\n    this.classList.add(_config_js__WEBPACK_IMPORTED_MODULE_0__[\"active\"]);\n    Object(_outside_click_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(this, _config_js__WEBPACK_IMPORTED_MODULE_0__[\"events\"], () => {\n      this.classList.remove(_config_js__WEBPACK_IMPORTED_MODULE_0__[\"active\"]);\n    });\n    // console.log(event);\n  }\n}\n\n//# sourceURL=webpack:///./js/modules/dropdown.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return initScrollAnimation; });\n/* harmony import */ var _config_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./config.js */ \"./js/modules/config.js\");\n\r\n\r\nfunction initScrollAnimation() {\r\n  const sections = document.querySelectorAll('[data-anime^=\"scroll\"]');\r\n  const halfWindow = window.innerHeight * 0.6;\r\n\r\n  function scrollAnimation() {\r\n    sections.forEach((section) => {\r\n      const sectionTop = section.getBoundingClientRect().top;\r\n      const isSectionVisible = (sectionTop - halfWindow) < 0;\r\n\r\n      if (isSectionVisible)\r\n        section.classList.add(_config_js__WEBPACK_IMPORTED_MODULE_0__[\"active\"]);\r\n      else if (section.classList.contains(_config_js__WEBPACK_IMPORTED_MODULE_0__[\"active\"]))\r\n        section.classList.remove(_config_js__WEBPACK_IMPORTED_MODULE_0__[\"active\"]);\r\n    });\r\n  }\r\n\r\n  if (sections.length) {\r\n    scrollAnimation();\r\n    window.addEventListener('scroll', scrollAnimation);\r\n  }\r\n}\n\n//# sourceURL=webpack:///./js/modules/scroll-animation.js?");
